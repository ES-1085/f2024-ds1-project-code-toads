...
ggsave("graphs.png", width = 6, height = 4, dpi = 300)
...
ggsave("covid_line_plot.png", width = 6, height = 4, dpi = 300)
```




```{r category-heatmap, fig.alt = c("Two heat maps that show either the percentage of children that scored below expectation or meeting/exceeding expectations in test scores for different categories across seasons and years. All seasons across the year '22-'23 generally have lower percentage of children at or above the threshold")}
...
ggplot(scores_long, aes(x = period_season, y = category, fill = percent)) +
  geom_tile(color = "white") +
  scale_fill_gradient(low = "lightyellow", high = "darkred") +
  facet_wrap(~ type, labeller = as_labeller(c(
    percent_meeting_exceeding = "Meeting/Exceeding",
    percent_below = "Below Expectations"
  ))) +
  labs(
...
ggsave("performance_heatmap.png", width = 10, height = 4, dpi = 300)
